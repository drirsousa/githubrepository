...
class RepositoryActivity : AppCompatActivity() {
    ...
    private fun prepareViews() {
        ...
        repositoryViewModel.repositoryItemItem.observe(this) { repositories ->
    ...
    private fun loadFirstPage() {
        ...
        Handler(Looper.getMainLooper()).postDelayed({ repositoryViewModel.fetchRepositories(PAGE_START) }, 1000)

        repositoryViewModel.countTotalPages.observe(this) { countTotalPages ->
            totalPages = countTotalPages
        }
    }

    private fun loadNextPage() {
        Handler(Looper.getMainLooper()).postDelayed({ repositoryViewModel.fetchRepositories(currentPage) }, 1000)
    }
